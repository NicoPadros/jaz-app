...
import 'package:gallery/studies/merienda_tracker/colors.dart';
    ...
    switch (category) {
      case PlaceCategory.favorite:
        return BitmapDescriptor.fromAssetImage(
            ...
            'lib/studies/merienda_tracker/assets/heart.png');
      case PlaceCategory.visited:
        return BitmapDescriptor.fromAssetImage(
            createLocalImageConfiguration(context, size: const Size.square(32)),
            'lib/studies/merienda_tracker/assets/visited.png');
