...
class PlaceTrackerApp extends StatelessWidget {
  ...
  static const String defaultRoute = routes.homeRoute;

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: const _PlaceTrackerHomePage(),
      debugShowCheckedModeBanner: false,
      initialRoute: PlaceTrackerApp.defaultRoute,
      routes: {
        PlaceTrackerApp.defaultRoute: (context) => const _PlaceTrackerHomePage(),
      },
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF836fa9),
        actions: [
          Padding(
